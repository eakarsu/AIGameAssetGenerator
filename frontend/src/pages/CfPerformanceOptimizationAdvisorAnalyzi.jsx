...
// Auto-generated page for: Performance optimization advisor analyzing polycount/texture

export default function CfPerformanceOptimizationAdvisorAnalyzi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-performance-optimization-advisor-analyzi', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Performance optimization advisor analyzing polycount/texture</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Performance optimization advisor analyzing polycount/texture resolution and recommending LOD variants.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Performance optimization advisor analyzing polycount/texture'}
        </button>
      </form>
