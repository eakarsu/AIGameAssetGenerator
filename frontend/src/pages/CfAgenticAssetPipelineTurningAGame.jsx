...
// Auto-generated page for: Agentic asset pipeline turning a game design doc into asset 

export default function CfAgenticAssetPipelineTurningAGame() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-asset-pipeline-turning-a-game', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Agentic asset pipeline turning a game design doc into asset </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Agentic asset pipeline turning a game design doc into asset requirements with iterative regenerations.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Agentic asset pipeline turning a game design doc into asset '}
        </button>
      </form>
