...
// Auto-generated page for: No animation-generation endpoint (rigging + animation from s

export default function GapNoAnimationGenerationEndpointRigging() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-animation-generation-endpoint-rigging', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No animation-generation endpoint (rigging + animation from s</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No animation-generation endpoint (rigging + animation from static model)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No animation-generation endpoint (rigging + animation from s'}
        </button>
      </form>
