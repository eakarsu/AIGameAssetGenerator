...
// Auto-generated page for: No scene-composition endpoint (multi-asset layout)

export default function GapNoSceneCompositionEndpointMultiAsse() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-scene-composition-endpoint-multi-asse', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No scene-composition endpoint (multi-asset layout)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No scene-composition endpoint (multi-asset layout)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No scene-composition endpoint (multi-asset layout)'}
        </button>
      </form>
