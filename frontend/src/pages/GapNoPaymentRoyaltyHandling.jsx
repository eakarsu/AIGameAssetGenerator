...
// Auto-generated page for: No payment / royalty handling

export default function GapNoPaymentRoyaltyHandling() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-payment-royalty-handling', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No payment / royalty handling</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No payment / royalty handling</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No payment / royalty handling'}
        </button>
      </form>
