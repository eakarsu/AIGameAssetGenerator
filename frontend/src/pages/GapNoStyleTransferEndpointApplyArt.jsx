...
// Auto-generated page for: No style-transfer endpoint (apply art style to base asset)

export default function GapNoStyleTransferEndpointApplyArt() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-style-transfer-endpoint-apply-art', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No style-transfer endpoint (apply art style to base asset)</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No style-transfer endpoint (apply art style to base asset)</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No style-transfer endpoint (apply art style to base asset)'}
        </button>
      </form>
