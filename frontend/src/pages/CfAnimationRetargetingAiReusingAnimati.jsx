...
// Auto-generated page for: Animation retargeting AI reusing animations across humanoid 

export default function CfAnimationRetargetingAiReusingAnimati() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-animation-retargeting-ai-reusing-animati', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Animation retargeting AI reusing animations across humanoid </h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Animation retargeting AI reusing animations across humanoid character models.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Animation retargeting AI reusing animations across humanoid '}
        </button>
      </form>
