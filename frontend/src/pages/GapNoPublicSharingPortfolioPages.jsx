...
// Auto-generated page for: No public sharing / portfolio pages

export default function GapNoPublicSharingPortfolioPages() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-public-sharing-portfolio-pages', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No public sharing / portfolio pages</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No public sharing / portfolio pages</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No public sharing / portfolio pages'}
        </button>
      </form>
