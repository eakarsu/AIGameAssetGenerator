...
// Auto-generated page for: No texture-refinement endpoint

export default function GapNoTextureRefinementEndpoint() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-texture-refinement-endpoint', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No texture-refinement endpoint</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No texture-refinement endpoint</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No texture-refinement endpoint'}
        </button>
      </form>
