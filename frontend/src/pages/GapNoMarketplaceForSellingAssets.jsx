...
// Auto-generated page for: No marketplace for selling assets

export default function GapNoMarketplaceForSellingAssets() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-marketplace-for-selling-assets', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No marketplace for selling assets</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No marketplace for selling assets</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No marketplace for selling assets'}
        </button>
      </form>
