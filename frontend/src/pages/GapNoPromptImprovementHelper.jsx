...
// Auto-generated page for: No prompt-improvement helper

export default function GapNoPromptImprovementHelper() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-prompt-improvement-helper', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No prompt-improvement helper</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No prompt-improvement helper</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No prompt-improvement helper'}
        </button>
      </form>
